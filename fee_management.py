...
class FeeStructure:
    ...
    def add_subject_fee(self, subject: str, amount: float) -> Tuple[bool, str]:
        ...
        return True, f"Subject '{subject}' fee set to PHP{amount:.2f}"
...
class FeeManager:
    ...
    def create_particular(self, name: str, amount: float, description: str = "") -> Tuple[bool, str]:
        ...
        self.save_data()
        return True, f"Particular '{name}' created: PHP{amount:.2f}"
    ...
    def record_payment(self, invoice_id: str, amount: float) -> Tuple[bool, str]:
        ...
        if amount > invoice.amount:
            return False, f"Payment amount exceeds invoice amount (PHP{invoice.amount:.2f})"
    ...
    def calculate_payroll(self, payroll_id: str, days_present: int, 
        ...
        self.save_data()
        return True, f"Payroll calculated: PHP{payroll.net_salary:.2f}"
